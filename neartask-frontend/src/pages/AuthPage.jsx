...
const workerSkills = ['Cleaning', 'Maid', 'Appliance Repair', 'Plumbing', 'Electrical', 'Moving', 'Gardening', 'Delivery', 'Other'];
    ...
    useEffect(() => {
        if (mode === 'register') {
            setRegisterForm((prev) => ({
                ...
                password: prev.password || loginForm.password
            }));
        } else {
            setLoginForm((prev) => ({
                ...prev,
                email: prev.email || registerForm.email,
                password: prev.password || registerForm.password
            }));
        }
    }, [mode]);
